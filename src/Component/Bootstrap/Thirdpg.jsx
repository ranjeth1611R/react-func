      ...
      <div className="row">
        ...
        <div className="col-5 d-flex justify-content-center align-items-center">
            <form action='' method='post'>
                <h1>Log in Exclusive</h1>
                <p>Enter your details below</p>
                <div className="form-group">
                <input type="text" placeholder='Email or Phone' className='form-control'/>
                <input type="password" placeholder='Password' className='form-control mt-3'/></div>
                <div className="d-flex justify-content-between pt-3"><button className='thirdbtn text-white'>Log in</button>
